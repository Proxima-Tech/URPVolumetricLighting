...
namespace Voxell.VolumetricLighting
{
    internal class VolumetricLightScattering : ScriptableRendererFeature
    {
        ...
        {
            [Header("Volumetric Properties")] [Range(0.1f, 1f)]
            ...
            [Header("Noise Properties")] public Vector2 noiseSpeed = new Vector2(0.5f, 0.5f);
            public float noiseScale = 1.0f;
            [Range(0.0f, 1.0f)] public float noiseStrength = 0.6f;
        }
